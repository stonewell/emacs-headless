...
typedef struct headless_char_struct
{
  int rbearing;
  int lbearing;
  int width;
...
struct headless_rect
{
  int x, y;
  int width, height;
};

typedef void *headless;

typedef headless Emacs_Pixmap;
typedef headless Emacs_Window;
typedef headless Emacs_Cursor;
typedef headless Drawable;

#define NativeRectangle struct headless_rect
